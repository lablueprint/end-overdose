const lessons = [
    ...
    },
    {
        ...
        content: {
            'Fentanyl is an opioid painkiller that can be used in medical settings for surgery or treating severe pain.':
                '',
            'Fentanyl has become increasingly found contaminating other substances manufactured and purchased outside of regulated settings.':
                {
                    'The fentanyl often found mixed into other drugs is illegally manufactured, meaning there is no regulation of its strength which can make it extremely addictive and lethal.':
                        '',
                    'Fentanyl is approximately 50-100 times stronger than morphine (NIDA).':
                        '',
                },
            'Fentanyl analogs are the different variations of fentanyl. They often have similar but different chemical structures and may be produced in illegal settings to increase strength compared to medical-grade fentanyl.':
                {
                    'On average it takes approximately 2mg of fentanyl for a person to overdose, but exact amount can depend on the analog of fentanyl ingested, the person’s tolerance to fentanyl/opioids, and the method of ingestion.':
                        '',
                    'For an individual who has no tolerance to opioids, a small dose of fentanyl can be extremely lethal.':
                        '',
                },
            video: {
