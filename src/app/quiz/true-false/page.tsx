...
import '../styles.css';
import trueFalseQuestions from './questions';
...
export default function TrueFalse() {
    ...
    if (started && !completed) {
        ...
        return (
            <div className="true-false-container">
                <div className="question-container">
                    <h1 style={{ fontSize: '2rem' }}>True or False</h1>
                    <div>You will be presented a statement about the</div>
                    <div>lesson you just did.</div>
